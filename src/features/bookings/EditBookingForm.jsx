...
function EditBookingForm({ booking = {}, onClose }) {
  ...
  const { editBookingMutation, isEditing } = useEditBooking();
  ...
  const extraPrice = hasBreakfast ? numNights * numGuests * BREAKFAST_PRICE : 0;
  const totalPrice = cabinPrice + extraPrice;

  const isWorking = isEditing || isLoadingGuests || isLoadingCabins;
